...
def dh_generate_parameters(generator: int = 2, key_size: int = 512) -> dh.DHParameters:
...
def dh_derive_shared_key(
    private_key: dh.DHPrivateKey, peer_public_key: dh.DHPublicKey
) -> bytes:
